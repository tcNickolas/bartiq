...
- Using a step function (Heaviside theta) allows us to model cases where the cost has different values depending on whether a given parameter is below or above certain threshold.
